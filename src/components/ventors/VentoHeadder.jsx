            ...
            <div className='container mx-auto px-4 py-2 md:flex md:justify-between md:items-center'>
                ...
                <div className={`md:flex ${isMenuOpen ? 'block' : 'hidden'}`}>
                    <div className='flex flex-col md:flex-row md:space-x-4 items-center mt-4 md:mt-0'>
                        <VendorHeadderNavItem icon='/dashboard1.png' text='DashBoard' to="/vendors" />
                        <VendorHeadderNavItem icon='/shopping-bag.png' text='Branch' to="/vendors/add-Branch" />
                        <VendorHeadderNavItem icon='/bar-chart.png' text='Ads' to='/vendors/Vendor-Ad' />
                    </div>
