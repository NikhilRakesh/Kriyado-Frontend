...
const VendorRegisterationForm = () => {
    ...
    return (
        <div className='bg-gray-50 rounded-lg p-5 md:py-10  h-[550px] overflow-scroll customscrollbar '>
            <div className=''>
            ...
            <div className=' mt-2 '>
                <div className=''>
                    ...
                    <div className=''>
                        {formData && (formData?.Photosofstore?.map((img, index) => (
                            <div className=' h-[100px] shadow-lg  border mb-5 ' key={index}>
                ...
                <div className=' mt-7 md:mt-0'>
                    ...
                    <div className='flex  mt-4'>
                        ...
                        <Link to='/Vendor-register/Discount-Entry' className='py-1 px-2 mx-4 bg-[#9F5080] rounded-lg text-white w-3/6 text-center ' >
