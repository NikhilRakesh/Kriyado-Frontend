            ...
            <div className='mt-5 mb-4'>
                < div className=' flex flex-col gap-3 bg-white border p-5 rounded-lg mb-7 shadow-sm'>
                    ...
                    <div className='my-5 md:flex gap-7 '>
                        <div className='md:w-4/12 py-2'>
                            <p className='text-xs text-gray-400'>Discount Type</p>
                            <div className=' flex py-2 gap-2 mt-2'>
                    ...
                    <div className='flex justify-center'>
                        {buttonStatus.indexOf('add1') == -1 && (
                            <button className='bg-[#80509F] text-white px-4 py-1 rounded-md w-full md:w-min ' onClick={() => { handleAdd('add1') }}>Add</button>
                        )}
                    </div>
                    <div className='my-4'>
                    ...
                    <div className='my-5 md:flex gap-7 '>
                        ...
                        <div className='md:w-4/12 py-2 '>
                            <p className='text-xs text-gray-400'>Discount Type</p>
                            <div className=' flex gap-2 py-2  items-center mt-2'>
                                <div className='flex w-1/4 gap-3 '>
                    ...
                    <div className='flex justify-center'>
                        {buttonStatus.indexOf('add2') == -1 && (
                            <button className='bg-[#80509F] text-white px-4 py-1 w-full md:w-min rounded-md' onClick={() => { handleAdd('add2') }}>Add</button>
                        )}
                    </div>
                    <div className='my-4'>
                    ...
                    <div className='flex justify-center'>
                        {buttonStatus.indexOf('add3') == -1 && (
                            <button className='bg-[#80509F] w-full md:w-min text-white px-4 py-1 rounded-md' onClick={() => { handleAdd('add3') }}>Add</button>
                        )}
                    </div>
