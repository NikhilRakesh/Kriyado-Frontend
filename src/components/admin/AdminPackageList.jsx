    ...
    return (
        <div className='w-full bg-white border border-gray-300 rounded-md p-1 px-4 my-3'>
            <div className='flex items-center justify-between p-2'>
                ...
                <p className='text-sm  w-3/12 font-bold '>Category</p>
                <p className='text-sm  w-3/12 font-bold '>Price</p>
                <p className='text-sm  w-3/12 font-bold '>Duration in days</p>
            ...
            <div className='overflow-x-auto overflow-y-scroll h-[400px] customscrollbar'>
                ...
                {count.map((c,index) => (
                    <div className='flex items-center px-2 py-3  border-gray-300  border-b' key={index}> 
                        <p className='text-sm w-3/12 '>Kriyado Utility</p>
                        <p className='text-sm w-3/12  '>Digital Product</p>
                        <p className='text-sm w-3/12  '>₹ 999</p>
                        <p className='text-sm w-3/12  '>63</p>
